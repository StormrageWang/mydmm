...
--添加作品番号表
GO
CREATE TABLE WORK_DISTINECT(
	CODE		VARCHAR(20)			NOT NULL,	--番号
	TITLE		NVARCHAR(200)		NOT NULL	--标题
)
--添加主键
GO
ALTER TABLE WORK_DISTINECT
	ADD CONSTRAINT PK_WORK_DISTINECT PRIMARY KEY (CODE)
...
CREATE TABLE TORRENT(
	...
	[TYPE]			INT					NOT NULL,	--类型
	WORK_CODE		VARCHAR(20)			NOT NULL	--番号
)
--添加外键
GO
ALTER TABLE TORRENT	
	ADD CONSTRAINT FK_TORRENT_WORK_CODE FOREIGN KEY(WORK_CODE) REFERENCES WORK_DISTINECT(CODE)
